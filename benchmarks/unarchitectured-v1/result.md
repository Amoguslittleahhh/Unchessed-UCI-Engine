...
Hydra v1-v5 and Apex v1 are experimental lineage labels. Unarchitectured v1 is canonical, but remains untrained and default-off until all export, runtime, calibration, and SPRT gates pass.
