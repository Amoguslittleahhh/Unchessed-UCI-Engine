#!/usr/bin/env python3
"""Provenance-disjoint calibration of Unarchitectured v1 against a real teacher.
...
(`tools/reference_forward_unarchitectured_v1.py`), which is cross-checked
...
# Mirrors POLICY_GUIDE in unarchitectured_v1_position_encoding; duplicated as a
...
def argument_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--package", type=Path, default=Path("artifacts/unarchitectured-v1-final.unarchv1"))
...
from unarchitectured_v1_position_encoding import (  # noqa: E402
    MAX_ACTIONS,
    POLICY_GUIDE,
    encode_position,
)
...
_REFERENCE_PATH = TOOLS / "reference_forward_unarchitectured_v1.py"


def load_reference_module():
    """Import the repository's validated Python reference forward pass."""
    spec = importlib.util.spec_from_file_location("_unarchv1_reference", _REFERENCE_PATH)
