...
def validate_record(fields: dict[str, str], origin: str, line_no: int) -> dict[str, Any]:
    ...
    if event == "persona_decision":
        ...
        result.update(
            ...
            accelerated_resilient_score_milli=sint(fields.get("accelerated_resilient_score_milli", "0"), "accelerated_resilient_score_milli", origin, line_no),
            accelerated_resilient_evidence_milli=sint(fields.get("accelerated_resilient_evidence_milli", "0"), "accelerated_resilient_evidence_milli", origin, line_no),
            accelerated_resilient_streak=uint(fields.get("accelerated_resilient_streak", "0"), "accelerated_resilient_streak", origin, line_no),
            action_full=bit(fields["action_full"], "action_full", origin, line_no),
        )
