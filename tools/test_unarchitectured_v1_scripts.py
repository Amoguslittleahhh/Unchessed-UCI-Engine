...
CANONICAL = (
    "unarchitectured_v1_base_data.py",
    "unarchitectured_v1_data.py",
    "unarchitectured_v1_uci_teacher_worker.py",
    "train_unarchitectured_v1_student_a100.py",
...
class UnarchitecturedV1ScriptNamingTests(unittest.TestCase):
    ...
    def test_current_scripts_parse_and_use_canonical_classes(self):
        student = ast.parse((TOOLS / "train_unarchitectured_v1_student_a100.py").read_text())
        oracle = ast.parse((TOOLS / "train_unarchitectured_v1_a100.py").read_text())
    ...
    def test_canonical_data_record_round_trip(self):
        import unarchitectured_v1_base_data as base_data
        import unarchitectured_v1_data as data
