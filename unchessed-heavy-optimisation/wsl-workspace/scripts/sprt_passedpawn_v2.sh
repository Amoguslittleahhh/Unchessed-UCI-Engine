...
PP_ENGINE=/home/amogusontheterminal/unchessed-ai/builds/unchessed-target-tunablepp2/release/unchessed-adapter
BASE_ENGINE=/home/amogusontheterminal/unchessed-ai/builds/unchessed-magic-src/target/release/unchessed-adapter
OUT=/home/amogusontheterminal/unchessed-ai/data/maia-data/sprt_passedpawn_v2_vs_magic.pgn
LOG=/home/amogusontheterminal/unchessed-ai/data/maia-data/sprt_passedpawn_v2_vs_magic.log

"$CUTECHESS" \
  -engine cmd="$PP_ENGINE" name=PassedPawnV2 option.Threads=1 option.Adaptive=false option.OwnBook=false option.Hash=256 option.PassedPawnMgPct=100 option.PassedPawnEgPct=100 \
