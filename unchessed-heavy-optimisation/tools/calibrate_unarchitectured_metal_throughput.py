#!/usr/bin/env python3
"""Time real-size Unarchitectured Metal oracle/student forward+backward steps on
...
from config/unarchitectured_metal_training.json -- selfcheck deliberately shrinks
...
Usage:
    python tools/calibrate_unarchitectured_metal_throughput.py --steps 50
"""
...
def calibrate_oracle(root, device, steps, warmup):
    from train_unarchitectured_metal_a100 import (
