...
MODULE_PATH = TOOLS / "unarchitectured_metal_watchdog.py"
SPEC = importlib.util.spec_from_file_location(
    "unarchitectured_metal_watchdog", MODULE_PATH
)
MODULE = importlib.util.module_from_spec(SPEC)
sys.modules[SPEC.name] = MODULE
SPEC.loader.exec_module(MODULE)
ROOT = TOOLS.parent
BASE_POLICY = json.loads((ROOT / "config/unarchitectured_metal_safety.json").read_text())
    ...
    def test_success_requires_valid_heartbeat(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            code = (
                ...
                "p.write_text(json.dumps({'architecture':'Unarchitectured Metal',"
