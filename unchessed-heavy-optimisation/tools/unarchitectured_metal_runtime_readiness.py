#!/usr/bin/env python3
"""Fail closed while the Unarchitectured Metal runtime safety gate is incomplete."""
...
REQUIREMENTS = {
    "canonical_data_module": "tools/unarchitectured_metal_data.py",
    "canonical_student_trainer": "tools/train_unarchitectured_metal_student_a100.py",
    "canonical_oracle_trainer": "tools/train_unarchitectured_metal_a100.py",
    "canonical_teacher_worker": "tools/unarchitectured_metal_uci_teacher_worker.py",
    "checkpoint_exporter": "tools/export_unarchitectured_metal.py",
    "package_inspector": "tools/inspect_unarchitectured_metal.py",
    "rust_package_loader": "unchessed-core/src/unarchitectured_metal.rs",
    "runtime_package_tests": "tools/test_unarchitectured_metal_runtime.py",
}
...
def main():
    ...
    if args.strict and not report["ready_for_engine_candidate_training"]:
        raise SystemExit("Unarchitectured Metal runtime safety is incomplete")
