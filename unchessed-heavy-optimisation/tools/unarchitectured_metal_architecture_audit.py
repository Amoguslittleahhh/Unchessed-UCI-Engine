#!/usr/bin/env python3
"""Audit canonical Unarchitectured Metal contracts present in this repository."""
...
import unarchitectured_metal_package as package

ARCHITECTURE = "config/unarchitectured_metal.json"
SAFETY = "config/unarchitectured_metal_safety.json"
CAPABILITIES = "config/unarchitectured_metal_runtime_capabilities.json"
RUNTIME = "unchessed-core/src/unarchitectured_metal_runtime.rs"
ARTIFACT = "artifacts/unarchitectured-metal-final.unmetal"
CANONICAL_SCRIPTS = (
...
def audit(root=ROOT):
    ...
    checks = {
        "canonical_name": architecture["name"] == "Unarchitectured Metal",
        "canonical_magic_config": architecture["runtime_file_magic"] == "UNMETAL1",
        "canonical_magic_package": package.MAGIC == b"UNMETAL1",
