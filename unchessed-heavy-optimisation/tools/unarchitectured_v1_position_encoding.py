#!/usr/bin/env python3
"""Shared Unarchitectured v1 position encoding for Python-side evaluation tools.

This mirrors `position_to_input` in `unchessed-core/src/aegis_v4_runtime.rs`
...
Self-check (reproduces the frozen start-position parity fixture):
  ...
  python3 tools/unarchitectured_v1_position_encoding.py --self-check
"""
