...
def parse_package(blob):
    ...
    if magic not in (MAGIC, LEGACY_MAGIC) or version != VERSION or header_size != HEADER_SIZE or reserved != 0:
        raise PackageError("unsupported UNMETAL1/UNARCHV1 header")
