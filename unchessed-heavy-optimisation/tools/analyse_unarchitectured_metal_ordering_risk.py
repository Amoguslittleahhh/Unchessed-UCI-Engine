#!/usr/bin/env python3
"""Explain *why* the Unarchitectured Metal root hint costs Elo, using offline data.
...
Usage
-----
    python3 tools/analyse_unarchitectured_metal_ordering_risk.py \\
...
from calibrate_unarchitectured_metal_policy import heuristic_move_score  # noqa: E402
