...
MODULE_PATH = Path(__file__).with_name("unarchitectured_metal_runtime_readiness.py")
SPEC = importlib.util.spec_from_file_location("unarchitectured_metal_runtime_readiness", MODULE_PATH)
