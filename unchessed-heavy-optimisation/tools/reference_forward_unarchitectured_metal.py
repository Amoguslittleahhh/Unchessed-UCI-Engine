...
Usage:
  python3 tools/reference_forward_unarchitectured_metal.py artifacts/unarchitectured-metal-final.unmetal
  python3 tools/reference_forward_unarchitectured_metal.py artifacts/unarchitectured-metal-final.unmetal --all-exits
"""
import json
import math
import struct
