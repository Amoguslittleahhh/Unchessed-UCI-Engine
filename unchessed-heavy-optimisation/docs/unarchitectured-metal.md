...
**Unarchitectured Metal is the first canonical version of the unified neural/search
...
Unarchitectured Metal canonically consists of:
...
```text
config/unarchitectured_metal.json
config/unarchitectured_metal_training.json
config/unarchitectured_metal_student.json
config/unarchitectured_metal_safety.json
docs/unarchitectured-metal.md
tools/unarchitectured_metal_base_data.py
tools/unarchitectured_metal_data.py
tools/unarchitectured_metal_uci_teacher_worker.py
tools/train_unarchitectured_metal_student_a100.py
tools/train_unarchitectured_metal_a100.py
tools/calibrate_unarchitectured_metal_throughput.py
tools/reference_forward_unarchitectured_metal.py
tools/unarchitectured_metal_position_encoding.py
tools/build_unarchitectured_metal_calibration_corpus.py
tools/calibrate_unarchitectured_metal_policy.py
tools/smoke_unarchitectured_metal_uci.py
tools/unarchitectured_metal_dataset_gate.py
tools/unarchitectured_metal_runtime_readiness.py
tools/unarchitectured_metal_safety.py
tools/unarchitectured_metal_watchdog.py
```
...
`unarchitectured_metal_runtime.rs` remains an internal compatibility name, not a second
architecture.

## Experimental lineage

| Experimental label | Contribution carried into Unarchitectured Metal |
|---|---|
...
Unarchitectured Metal includes the post-v1-experiment safeguards:
...
`config/unarchitectured_metal_safety.json` and
`tools/unarchitectured_metal_safety.py` implement a fail-closed controller. Every
...
`tools/unarchitectured_metal_watchdog.py` runs outside `torchrun`; if startup or
...
Unarchitectured Metal does not create an `int64` permutation of every record on
...
`tools/unarchitectured_metal_architecture_audit.py` checks the canonical config,
...
See `benchmarks/unarchitectured-metal/runtime-forward-2026-08-22.md`.

## Promotion gates

Unarchitectured Metal becomes usable only after all of the following pass:
...
calibration evidence is in `docs/unarchitectured-metal-runtime-optimization.md`,
`docs/unarchitectured-metal-integration-trial.md`, and
`docs/unarchitectured-metal-calibration.md`. Experimental predecessor names
