# Why the Unarchitectured v1 root hint costs Elo
...
`tools/analyse_unarchitectured_v1_ordering_risk.py` replays the real exported
...
- The corpus is provenance-disjoint at the source-population level only, as
  documented in `docs/unarchitectured-v1-calibration.md`.
