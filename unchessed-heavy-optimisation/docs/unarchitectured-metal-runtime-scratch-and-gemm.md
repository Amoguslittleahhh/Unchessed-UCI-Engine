# Unarchitectured Metal runtime: default-path GEMM tiling and scratch reuse
...
`unarchitectured_metal_runtime.rs` so the sequential forward pass does less allocation
