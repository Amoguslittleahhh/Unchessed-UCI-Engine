...
This report assesses exactly one question: **should the project replace or augment single-move classification with multi-ply continuation prediction for Maia-style policy and Unarchitectured v1, given the measured forward budget and the first-iteration failure?**
