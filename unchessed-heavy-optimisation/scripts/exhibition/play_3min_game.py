...
ADAPTER = "/home/amogusontheterminal/unchessed-ai/builds/unchessed-kingsafety-src/target/release/unchessed-adapter"
...
OUTDIR = f"/home/amogusontheterminal/unchessed-ai/results/tenmin_3min_series/game{GAME_NUM}"
os.makedirs(OUTDIR, exist_ok=True)

START_MS = 3 * 60 * 1000  # 3 minutes
INC_MS = 0
...
# Genuine adaptive mode -- no forced full, no strength limiting. The
# engine's own live opponent-Elo model / persona system decides how to
# play, exactly as it would in a real En Croissant game.
setup(adapter, {"Threads": 1, "Adaptive": "true", "OwnBook": "true", "Hash": 128})
# Full-strength RubiChess: no LimitNps, no strength option of any kind.
...
game = chess.pgn.Game()
game.headers["White"] = "UnchessedAdapter" if ADAPTER_IS_WHITE else "RubiChessFull"
game.headers["Black"] = "RubiChessFull" if ADAPTER_IS_WHITE else "UnchessedAdapter"
