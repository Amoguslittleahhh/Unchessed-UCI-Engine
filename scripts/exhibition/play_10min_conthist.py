...
OUTDIR = f"/home/amogusontheterminal/unchessed-ai/results/tenmin_conthist_series/game{GAME_NUM}"
...
# Genuine adaptive mode, ContHistPct=100 (the candidate value under test
# while the SPSA pass separately looks for a tuned value). Full-strength
# RubiChess: no strength-limiting options at all.
setup(adapter, {"Threads": 1, "Adaptive": "true", "OwnBook": "true", "Hash": 128, "ContHistPct": 100})
