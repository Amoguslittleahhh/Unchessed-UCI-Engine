...
SING_ENGINE=/home/amogusontheterminal/unchessed-ai/builds/unchessed-target/release/unchessed-adapter
BASE_ENGINE=/home/amogusontheterminal/unchessed-ai/builds/unchessed-seefutility-src/target/release/unchessed-adapter
OUT=/home/amogusontheterminal/unchessed-ai/data/maia-data/sprt_singularv2_vs_seefutility.pgn
LOG=/home/amogusontheterminal/unchessed-ai/data/maia-data/sprt_singularv2_vs_seefutility.log

"$CUTECHESS" \
  -engine cmd="$SING_ENGINE" name=SingularV2 option.Threads=1 option.Adaptive=false option.OwnBook=false option.Hash=256 \
