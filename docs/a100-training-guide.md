...
evidential WDL, private human/guide adapters, and per-action regret. Hydra Apex
v5 adds an automatically scaled 29M-878M-parameter training-only oracle, real
